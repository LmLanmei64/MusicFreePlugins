...
async function getMusicComments(musicItem, page = 1) {
    ...
    try {
        const response = await axios_1_1.default.get(url, {
            params: {
                id: musicItem.id,
                limit: limit,
                offset: offset
